...
$\text{The change in value } \frac{\Delta f}{\Delta t} \text{ can be defined as a piecewise funciton}$
...
Using $\text{Equation 1}$, we can calculate the allowed change, $\frac{\Delta f}{\Delta t}$, since the previous iteration 
